...
\begin{frame}{Définitions}
    \begin{block}{Définition - Graphe orienté}
        ...
        \begin{itemize}
            ...
            \item Un arc $e=(u,v)$ est un couple d'éléments de $V$.
        \end{itemize}
    \end{block}
    \medskip
    \vspace{2.15em}
...
\lstset{keywordstyle=\ttfamily\bf\color{csred}, basicstyle=\ttfamily}
% DFS (code)
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1.35]
            \begin{scope}[xshift=-2cm, yshift=-3cm,
                box/.style={rectangle, draw, minimum width=.8cm, minimum height=.5cm}
            ]
                \only<1,10>{\node at (0.5,2.4) {$\emptyset$};}
                \node at (0.5,1.8) {\textbf{Pile}};

                \only<1>{}

                \only<2>{
                \node[box] at (0.5,2.4) {1};
                }

                \only<3>{
                \node[box] at (0.5,2.4) {1};
                \node[box] at (0.5,2.9) {3};
                }

                \only<4>{
                \node[box] at (0.5,2.4) {1};
                \node[box] at (0.5,2.9) {3};
                \node[box] at (0.5,3.4) {9};
                }

                \only<5>{
                \node[box] at (0.5,2.4) {1};
                \node[box] at (0.5,2.9) {3};
                \node[box] at (0.5,3.4) {7};
                }
                ...
                \node[box] at (0.5,2.9) {3};
                \node[box] at (0.5,3.4) {7};
                \node[box] at (0.5,3.9) {8};
                }

                \only<7>{
                \node[box] at (0.5,2.4) {1};
                \node[box] at (0.5,2.9) {5};
                }

                \only<8>{
                \node[box] at (0.5,2.4) {1};
                \node[box] at (0.5,2.9) {5};
                \node[box] at (0.5,3.4) {4};
                }
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1.5]
            \begin{scope}[yshift=-2.6cm,
                qbox/.style={rectangle, draw, minimum width=.8cm, minimum height=.5cm}
            ]
                \node at (2.5,0.8) {\textbf{File}};
                \only<1,11>{
                    \node at (2.5,0.1) {$\emptyset$};
                }

                \phantom{\node[qbox] at (-.3,0.1) {1};}
                \phantom{\node[qbox] at (5.3,0.1) {1};}
                \phantom{\node at (2.5,0.1) {$\emptyset$};}
                ...
                \only<4>{
                    \node[qbox] at (.5,0.1) {3};
                    \node[qbox] at (1.3,0.1) {5};
                }
                \only<5>{
                    \node[qbox] at (1.3,0.1) {5};
                    \node[qbox] at (2.1,0.1) {9};
                }
                \only<6>{
                    \node[qbox] at (1.3,0.1) {5};
                    \node[qbox] at (2.1,0.1) {9};
                    \node[qbox] at (2.9,0.1) {7};
                }
                \only<7>{
                    \node[qbox] at (2.1,0.1) {9};
                    \node[qbox] at (2.9,0.1) {7};
                    \node[qbox] at (3.7,0.1) {4};
                }
                \only<8>{
                    \node[qbox] at (2.9,0.1) {7};
                    \node[qbox] at (3.7,0.1) {4};
                ...
                \only<9>{
                    \node[qbox] at (3.7,0.1) {4};
                    \node[qbox] at (4.5,0.1) {8};
                }
                \only<10>{
                    \node[qbox] at (4.5,0.1) {8};
                    \node[qbox] at (5.3,0.1) {6};
                }
...
\begin{frame}{Algorithme de Dijkstra}
    \textbf{Entrées} : Un graphe $G=(V,E,w)$, un sommet de départ $s$
    \medskip
...
\begin{frame}{Arbre couvrant minimal}
    \begin{block}{Arbre couvrant minimal (MST)}
        Soit un graphe non-orienté, connexe $G=(V,E)$. Un arbre couvrant minimal de $G$ (\textit{Minimum Spanning Tree}) est un sous-graphe acyclique connexe de $G$ contenant tous les sommets de $G$ et tel que la somme des poids de ses arêtes est minimal.
    \end{block}
...
\begin{frame}{Algorithme de Kruskal}
        \textbf{Entrées} : Un graphe connexe pondéré $G=(V,E,w)$\\
    ...
    \begin{algorithmic}
        ...
        \State $P \gets \textbf{Init}(|V|)$ \Comment{Structure de données Unir-Trouver}
